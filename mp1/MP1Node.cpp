...
// This code is written by Shrashti Singhal
void MP1Node::SendMemberShipTableTo(MsgTypes msgType, Address* peerAddres)
{
    ...
    // get toknow who is sending the message/packet
...
bool MP1Node::UpdateMemberListFromReceivedTable(char *msgPackage, int size)
{
    ...
    {
        // when we donot know the size of the package
        return false;
    }
    ...
    {
        // when we donot have enough information about all thetable entries
        return false;
    }
...
bool MP1Node::GOSSIPHandler(char *msgPackage, int size)
{
    ...
    // the below code sends a GossipReply message
